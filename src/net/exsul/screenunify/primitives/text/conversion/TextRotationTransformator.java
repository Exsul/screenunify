package net.exsul.screenunify.primitives.text.conversion;

import net.exsul.screenunify.metrics.Metrics;
import net.exsul.screenunify.primitives.text.Text;
import net.exsul.screenunify.primitives.text.conversion.base.TextTransformator;
import net.exsul.screenunify.primitives.text.conversion.base.TextTransformatorDecorator;
